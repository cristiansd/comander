...
$query_RegMenus = "SELECT * FROM menus WHERE estadoMenu=1";
        ...
        <div class="no-seleccionable">
            ...
            if ($totalRows_RegMenus > 0) {
                ...
                <ul id="listado" class="w3-ul w3-card-2"style="margin-top: 10px;">
                    <?php do { ?>            
                        <li style="height: 90px;padding: 0px;margin-top: 1px;margin-bottom: 1px;" onclick="conection('verSubMenusUsuario.php?idMenu=<?php echo $row_RegMenus['idMenu'] . "&nombreMenu=" . $row_RegMenus['nombreMenu']; ?>');
                                        changeColor(this);">
                            <div class="w3-centered w3-medium letraBotones"style="padding-top: 30px;padding-left: 10px;margin-left: 25px;"><?php echo recuperarString($row_RegMenus['id_string']); ?><br><?php echo number_format($row_RegMenus['precioMenu'], 2); ?>&euro;</div>
                        </li>
