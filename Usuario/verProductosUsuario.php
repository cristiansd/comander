...
$query_RegProducto = "SELECT * FROM productos WHERE estadoProducto=1 AND idSubcategoriaProducto=" . $idSubCategoria;
        ...
        <div class="no-seleccionable">
            ...
            if ($totalRows_RegProducto > 0) {
                ...
                <ul id="listado" class="w3-ul w3-card-2"style="margin-top: 10px;">
                    <?php do { ?>
                        <li style="height: 90px;padding: 0px;margin-top: 1px;margin-bottom: 1px;" onclick="conection('mostrarDetalleUsuario.php?idProducto=<?php echo $row_RegProducto['idProducto']."&nombre=".utf8_encode($row_RegProducto['nombreProducto'])."&imagen=".$row_RegProducto['id_imagen']; ?>');
                                        changeColor(this);">                                 
