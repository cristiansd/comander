...
$query_RegCategorias = "SELECT * FROM categorias WHERE estadoCategoria=1";
        ...
        <div class="no-seleccionable">
            ...
            if ($totalRows_RegCategorias > 0) {
                ...
                <ul id="listado" class="w3-ul w3-card-2"style="margin-top: 10px;">
                    <li style="height: 90px;padding: 0px;margin-top: 1px;margin-bottom: 1px;" onclick="conection('elegirMenuUsuario.php');changeColor(this);">                                 
                        <img src="../archivos/ImagenesAdd/menu.jpg" class="w3-left" style="width:90px;height:88px;">
                        <div class=" w3-medium letraBotones"style="padding-top: 30px;padding-left: 10px;margin-left: 100px;"><?php echo $menusBidTag; ?></div>
                    </li>
                    <?php do { ?>           
                        <li style="height: 90px;padding: 0px;margin-top: 1px;margin-bottom: 1px;" onclick="conection('verSubcategoriasUsuario.php?idCategoria=<?php echo $row_RegCategorias['idCategoria'] . "&imagen=" . $row_RegCategorias['id_imagen'] . "&nombre=" . utf8_encode($row_RegCategorias['nombreCategoria']); ?>');
                                        changeColor(this);">                                 
                            <img src="../includes/imagen.php?id=<?php echo $row_RegCategorias['id_imagen']."&local=".$_SESSION['establecimiento']; ?>" class="w3-left" style="width:90px;height:88px;">
                            <div class="w3-centered w3-medium letraBotones"style="padding-top: 30px;padding-left: 10px;margin-left: 100px;"><?php echo recuperarString($row_RegCategorias['id_string']); ?></div>
                        </li>
