...
if (isset($_GET['accesscheck'])) {
  ...
  $LoginRS__query= "SELECT id_usuario, nick_usuario, nivel_permiso FROM usuarios_comander WHERE email_usuario='$emailUser'";    
...
if ($loginFoundUser) {
    ...
    mysqli_select_db($comcon, $database_comcon );
    $establecimiento__query="SELECT hostname_database, name_database, username_database,password_database, imagen, nombre_establecimiento, direction FROM establecimientos WHERE id_establecimiento='$establecimiento'";
    ...
    $_SESSION['imagen_local'] = $establecimientoRS_rows['imagen'];
    $_SESSION['nombre_local'] = $establecimientoRS_rows['nombre_establecimiento'];
    $_SESSION['direccion_local'] = $establecimientoRS_rows['direction'];
