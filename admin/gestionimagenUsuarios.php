...
<html>
	...
	?>
        <script>
		opener.document.form1.imagenUsuario.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
        <?php
        } else {
        ?>
        <form action="gestionimagenUsuarios.php" method="post" enctype="multipart/form-data" id="form1">
            <p>
