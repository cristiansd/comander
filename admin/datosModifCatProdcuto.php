...
$RowConsultaproductos=ConsultaRowsBD("productos","idProductos","$identificador");
if (isset ($_GET['categoria'])){
	$idetificador=$_GET['categoria'];        
}
?>
<option selected value="<?php echo $idetificador?>"><?php echo ObtenerNombreCategoria($idetificador); ?></option>
