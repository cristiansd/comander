...
<html>
	...
	?>
        <script>
		opener.document.form1.imagenSubcategoria.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
        <?php
        } else {
        ?>
        <form action="gestionimagenSubcategorias.php" method="post" enctype="multipart/form-data" id="form1">
            <p>
